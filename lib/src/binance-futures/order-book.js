const BinanceWs = require('@gabrielgrijalva/crypto-exchanges').BinanceFuturesWs;
const BinanceRest = require('@gabrielgrijalva/crypto-exchanges').BinanceFuturesRest;
