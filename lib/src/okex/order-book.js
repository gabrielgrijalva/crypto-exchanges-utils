...
const OkexWs = require('@gabrielgrijalva/crypto-exchanges').OkexWs;
...
module.exports = function OkexOrderBook(type, symbol) {
   ...
   */
  function onOpen() {
    console.log(`OkexOrderBook:${symbol} connection open.`);
   ...
   */
  function onClose() {
    console.log(`OkexOrderBook:${symbol} connection close.`);
    ...
    if (okexOrderBook.status !== 'disconnected') {
      ...
      setTimeout(() => okexOrderBook.okexWs.connect(), waitSeconds);
    }
  }
  ...
  function onError(error) {
    console.log(`OkexOrderBook:${symbol} connection error.`);
  ...
  function onMessage(message) {
    ...
    if (messageParsed.table === `${type}/depth` && messageParsed.action
      === 'partial') {
