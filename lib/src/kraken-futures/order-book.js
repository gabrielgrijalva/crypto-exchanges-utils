...
module.exports = function KrakenOrderBook(symbol) {
  ...
  function onMessage(message) {
    ...
    if (krakenOrderBook.asks[0].price < krakenOrderBook.bids[0].price) {
      throw 'ask less than bid';
    }
    if (krakenOrderBook.bids[0].price > krakenOrderBook.asks[0].price) {
      throw 'bid greated than ask';
    }
  }
